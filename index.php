<!DOCTYPE html>
<html lang="en" d="">
<head><!-- Removed by WebCopy --><!--<base href="/lander/tiktok20210622/index.html">--><!-- Removed by WebCopy --><meta http-equiv="Content-Type" content="text/html; charset=windows-1252"><meta https-equiv="Content-Type" content="text/html; charset=UTF-8">
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		<meta name="theme-color" content="#171c1e">
		<title>TikTok +18 Hot videos</title>

	    <link rel="shortcut icon" type="image/png" href="lander/tiktok20210622/logo.png">
				<style>
			*{font-family: 'Roboto';padding: 0;margin: 0;color: #000;outline: none;}
            body{overflow:hidden;filter: blur();}
            .bg_blur{z-index: -1; position: absolute;top: 0;left: 0;height: 100vh;width: 100%;filter: blur(0px);background-size: cover;background-position: center;}
            .bg_blur1{background-image: url("lander/tiktok20210622/1.jpg");}
        ...
        margin: auto;letter-spacing: 1px;}
            .btn a{text-decoration: none;color: #fff;text-align: center;}
    ...
    <!-- TikTok +18 are available for users who mark that they are at least 18 years old and confirm an e-mail. -->
        ...
        <div class="container">
            <div class="logo_wrap">
                ...
                <div class="logo"><img src="lander/tiktok20210622/logo.png" alt=""></div>
                <div class="tiktok"><img src="lander/tiktok20210622/tiktok.png" alt=""></div>
				
            </div>
            <div class="text">
			
                <p>1.REGISTER NOW</p>
                <p>2.CONFIRM YOUR E-MAIL</p>
                <p>3.WATCH NAKED TIKTOK VIDEOS</p>
				            </div>
            <div class="btn"><a href="http://fun.yourangel.club/">TAP HERE FREE REGISTRATION</a></div>
        </div>
